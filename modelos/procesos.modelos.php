...
class ModeloProcesos{
            ...
            public function modeloBuscarClientes($buscar){
                ...
                try{
                    ...
                    $consulta = "SELECT id_usuario,nombre,celular,cumpleanos,nombreColaborador FROM CLIENTES WHERE nombre LIKE '%$buscar%'"; 
                    $resultado = mysqli_query($con,$consulta);
                    ...
                    while($fila=mysqli_fetch_array($resultado,MYSQLI_ASSOC)){
                        ...
                        echo "
                            <div class='containerLista_filaServicios'>
                                ...
                                <p class='containerLista_item'>S/. ".$fila['precio_base']."</p>
